...
<%--   <p>  경복궁1 :  <img alt="경복궁1" src="${pageContext.request.contextPath}/upload/3ea46a55-fa04-40a1-9db6-6cf9aad37963_20150702_115327.jpg">
 ...
 --%>	
   ...
   <form id="form1" action="uploadForm" method="post" enctype="multipart/form-data">
	...
	upLoAD fILE : ${savedName1 }
	<img alt="UpLoad결과" src="${pageContext.request.contextPath}/upload/${savedName1}"><p>
	<a href="uploadFileDelete" target="myBatisFrame">upLoad삭제Test</a>
	<!-- 시간상 올라간것 강제코딩 -->
